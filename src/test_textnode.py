...
class TestTextNodeToHtmlNode(unittest.TestCase):
    ...
    def test_image(self):
        node = TextNode("This is an image", text_type_image, "https://genericlink.com")
        html_node = text_node_to_html_node(node)
        self.assertEqual(html_node.tag, "img")
        self.assertEqual(html_node.value, "")
        self.assertEqual(html_node.props, {"src": "https://genericlink.com", "alt": "This is an image"})

    def test_link(self):
        node = TextNode("This is a link", text_type_link, "https://genericlink.com")
        html_node = text_node_to_html_node(node)
        self.assertEqual(html_node.tag, "a")
        self.assertEqual(html_node.value, "This is a link")
        self.assertEqual(html_node.props, {"href": "https://genericlink.com"})
